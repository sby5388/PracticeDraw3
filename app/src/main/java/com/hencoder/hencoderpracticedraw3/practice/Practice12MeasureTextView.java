...
public class Practice12MeasureTextView extends View {
     ...
     * text1的宽度
     */
    private float mMeasuredText1;

    /**
     * text2的宽度
     */
    private float mMeasuredText2;
...

    {
        ...
        // 画笔1测量Text1的宽度
        mMeasuredText1 = paint1.measureText(text1);
        mMeasuredText2 = paint2.measureText(text2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text1, 20, 200, paint1);
        canvas.drawText(text2, 20 + mMeasuredText1, 200, paint2);
        canvas.drawText(text3, 20 + mMeasuredText1 + mMeasuredText2, 200, paint1);
    }
}
